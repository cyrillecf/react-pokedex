  ...
  const validateForm = () => {
    ...
    if(isAddForm()){
      ...
      if(!form.picture.value.startsWith(start) || !form.picture.value.endsWith(end)) {
        const errorMsg: string = "L'url n'est valide.";
          ...
          <div className="card hoverable">
            ...
            <div className="card-stacked">
              <div className="card-content">
                ...
                {/* Pokemon hp */}
                <div className="form-group">
                  <label htmlFor="name">Point de vie</label>
                ...
                {/* Pokemon cp */}
                <div className="form-group">
                  <label htmlFor="name">Dégâts</label>
                ...
                <div className="form-group">
                  ...
                  {types.map(type => (
                    <div key={type} style={{marginBottom: '10px'}}>
                      <label>
                        <input id={type} name="types" type="checkbox" className="filled-in" checked={hasType(type)} disabled={!isTypesValid(type)} onChange={e => selectType(type, e)}></input>
                        <span>
